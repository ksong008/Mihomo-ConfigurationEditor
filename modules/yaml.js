(function (window) {
    ...
    window.MihomoFeatureModules.createYamlModule = function (ctx) {
        ...
        const yamlBuilders = window.MihomoFeatureModules && window.MihomoFeatureModules.YamlBuilders;
        if (!yamlBuilders) {
            throw new Error('YamlBuilders 未加载，请确认先引入 ./modules/yaml-builders.js');
        }
        const {
